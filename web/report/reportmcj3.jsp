            ...
            %>
                        ...
                        },
                        {
                            ...
                            table: {
                                ...
                                headerRows: 1,
                                heights: 40, 
                                widths:  ["*","auto","auto","auto",15,15,"auto"],
                                body: [
                                    [{ text: 'ART.NO/COL.',fontSize: 18}, { text: '<%=size1%>',fontSize: 15}, { text: '<%=size2%>',fontSize: 15}, { text: '<%=size3%>',fontSize: 15},{ text: '\t',fontSize: 15},{ text: '\t',fontSize: 15}, 'TOTAL'],
