...
public class DetailService {
    ...
    public Boolean UpdateDataToMIZUNONEWBARBOXDT(String customer_address, String po_old, String pobefore, String customer_num, String quantity_box, String initial, String numberbox_start, String numberbox_end, String po, String gw, String nw, String country, String quantitytotal_box, String description, String[] customer1_id, String[] customer2_id, String[] customer3_id, String[] customer4_id, String pallet, String prodorder, String destination, String date, String firstdigitbefore, String startbox, String endbox, String boxseq) throws SQLException, NamingException, ClassNotFoundException {
        Boolean status = false;
        int ax = getboxseq() + 1;
        try {
            HashMap<String, String> addresstsg = GetAddress("TSG");
            ...
            for (int n = Integer.parseInt(numberbox_start); n < Integer.parseInt(numberbox_end) + 1; n++) {
                ...
                ps.setString(4, "TSG");
                ps.setString(5, addresstsg.get("address1"));
                ps.setString(6, addresstsg.get("address2"));
                ps.setString(7, addresstsg.get("address3"));
                ps.setString(8, addresstsg.get("address4"));
                ps.setString(9, customer_num);
                ps.setString(10, addresscustomer.get("address1"));
                ps.setString(11, addresscustomer.get("address2"));
                ps.setString(12, addresscustomer.get("address3"));
                ps.setString(13, addresscustomer.get("address4"));
                ps.setString(14, quantity_box);
                ps.setString(15, description);
                ps.setString(16, gw);
                ps.setString(17, nw);
                ps.setString(18, country);
                ps.setString(19, customer1_id[0]);
                ps.setString(20, customer1_id[1]);
                ps.setString(21, customer1_id[2]);
                ps.setString(22, customer1_id[3]);
                ps.setString(23, customer1_id[4]);
                ps.setString(24, customer2_id[0]);
                ps.setString(25, customer2_id[1]);
                ps.setString(26, customer2_id[2]);
                ps.setString(27, customer2_id[3]);
                ps.setString(28, customer2_id[4]);
                ps.setString(29, customer3_id[0]);
                ps.setString(30, customer3_id[1]);
                ps.setString(31, customer3_id[2]);
                ps.setString(32, customer3_id[3]);
                ps.setString(33, customer3_id[4]);
                ps.setString(34, customer4_id[0]);
                ps.setString(35, customer4_id[1]);
                ps.setString(36, customer4_id[2]);
                ps.setString(37, customer4_id[3]);
                ps.setString(38, customer4_id[4]);
                ps.setString(39, pallet);
                ps.setString(40, prodorder);
                ps.setString(41, "N");
                ps.setString(42, destination);
                ps.setString(43, po_old);
    ...
    public Boolean AddDataToMIZUNONEWBARBOXHD(String customer_address, String customer_num, String quantity_box, String initial, String numberbox_start, String numberbox_end, String po, String gw, String nw, String country, String quantitytotal_box, String description, String[] customer1_id, String[] customer2_id, String[] customer3_id, String[] customer4_id, String pallet, String prodorder, String destination, String date) throws SQLException, NamingException, ClassNotFoundException {
        Boolean status = false;
        int ax = getboxseq() + 1;
        try {
